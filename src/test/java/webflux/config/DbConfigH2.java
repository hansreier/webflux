...
public class DbConfigH2 extends AbstractR2dbcConfiguration {
    ...
    public H2ConnectionFactory connectionFactory() {
        LOG.info("H2 db: {}", dbname);
        LOG.info("H2 User: {}", username);
        LOG.info("dbCloseDelay: {}", dbCloseDelay);
        LOG.info("dbCloseOnExit: {}",dbCloseOnExit);
        LOG.info("mode: {}", mode);
    ...
    public ConnectionFactoryInitializer initializer(
        ...
        LOG.info("H2 testconfig initializing connection and database");
